...
class MessagesActivity : ComponentActivity() {
    ...
    // Создайте необходимые модели представления, используя "factory"
...
//                MyOwnCustomScreen()   // Мой собственный пользовательский экран
            }
        }
    }
    ...
    fun MyOwnCustomScreen() {
        ...
        Box(modifier = Modifier.fillMaxSize()) {
            Scaffold(
                ...
                bottomBar = {
                    MessageComposer( // 3 - Добавьте композитора
                        composerViewModel,
                        onAttachmentsClick = {
                ...
                MessageList( // 4 - Создайте список сообщений и соедините действия
                    modifier = Modifier
    ...
    companion object {
        private const val KEY_CHANNEL_ID = "идентификатор канала"
